...
from payment_token.infrastructure import models  # noqa: F401 - imported for side effects
...
def run_migrations_online() -> None:
    ...
    """
    # Check if we have a pre-created connection (for testing)
    ...
    if connectable is None:
        ...
        # Testing mode: use pre-created connection
        context.configure(
